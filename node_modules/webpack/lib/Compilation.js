...
class Compilation extends Tapable {
	...
	buildModule(module, optional, origin, dependencies, thisCallback) {
		...
		// 举例：NormalModule 会执行normalmodule模块中的build函数
		module.build(
			this.options,
			this,
	 ...
	 */
	// 将模块添加到依赖列表 同时进行模块构建 执行buildModule
	...
	finish(callback) {
		...
		// finishModules 执行后 会得到经过loader之后的源码
